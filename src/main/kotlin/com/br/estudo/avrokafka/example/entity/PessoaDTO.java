 ...
 */
package com.br.estudo.avrokafka.example.entity;
...
public class PessoaDTO extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -9196653308274325102L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PessoaDTO\",\"namespace\":\"com.br.estudo.avrokafka.example.entity\",\"fields\":[{\"name\":\"nome\",\"type\":\"string\"},{\"name\":\"sobrenome\",\"type\":\"string\"},{\"name\":\"idade\",\"type\":\"int\"}]}");
   ...
   */
  public PessoaDTO(java.lang.CharSequence nome, java.lang.CharSequence sobrenome, java.lang.Integer idade) {
    this.nome = nome;
   ...
   */
  public static com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder newBuilder() {
    return new com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder();
  }
   ...
   * @return A new PessoaDTO RecordBuilder
   */
  public static com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder newBuilder(com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder other) {
    return new com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder(other);
  }
   ...
   * @return A new PessoaDTO RecordBuilder
   */
  public static com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder newBuilder(com.br.estudo.avrokafka.example.entity.PessoaDTO other) {
    return new com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PessoaDTO>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.br.estudo.avrokafka.example.entity.PessoaDTO other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.nome)) {
        this.nome = data().deepCopy(fields()[0].schema(), other.nome);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder setNome(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder clearNome() {
      nome = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder setSobrenome(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder clearSobrenome() {
      sobrenome = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder setIdade(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.br.estudo.avrokafka.example.entity.PessoaDTO.Builder clearIdade() {
